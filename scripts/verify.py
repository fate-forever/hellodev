...
FAST_TESTS = (
    ...
    "tests.test_v16_context_plane",
    "tests.test_v192_context_efficiency",
    "tests.test_v193_antigravity",
    ...
    "tests.test_v20_native_components",
    "tests.test_v201_acceptance_continuity",
    "tests.test_v202_acceptance_flow",
    "tests.test_v203_guided_acceptance",
    "tests.test_v204_alignment_fast_path",
    "tests.test_v205_adaptive_governance",
    "tests.test_v206_manifest_verification_plan",
    "tests.test_v207_intent_bootstrap",
    "tests.test_v208_measured_overhead",
