...
def main() -> int:
    ...
    sbom = {
        ...
        "name": "HelloDev-0.14.1-windows-x86_64",
        "documentNamespace": "https://github.com/fate-forever/hellodev/sbom/0.14.1/windows-x86_64",
    ...
    lines = [
        "# HelloDev 0.14.1 third-party notices",
        "",
