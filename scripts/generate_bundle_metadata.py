...
def main() -> int:
    ...
    sbom = {
        ...
        "name": "HelloDev-0.16.0-windows-x86_64",
        "documentNamespace": "https://github.com/fate-forever/hellodev/sbom/0.16.0/windows-x86_64",
    ...
    lines = [
        "# HelloDev 0.16.0 third-party notices",
        "",
