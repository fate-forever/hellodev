...
class V13GatewayTests(unittest.TestCase):
    ...
    def test_optional_dependency_and_release_workflow_are_bounded(self) -> None:
        ...
        self.assertNotIn("pypa/gh-action-pypi-publish", publish)
        self.assertIn("release-build-${{ github.event.release.tag_name }}", publish)
        ...
        self.assertEqual(verify_release_version("v0.21.3")["version"], "0.21.3")
